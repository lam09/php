...
$(function($) {
    ...
    function cb(start, end) {
        var a = $('#limit').val();
        var b = a+"&"+"start="+start.format('YYYY-MM-DD')+'&'+'end='+end.format('YYYY-MM-DD');
        if (x>0){
            window.location = b;
        }
        x++;
    ...
    $('#reportrange').daterangepicker({
        ranges: {
            ...
            'POSLEDNÝ MESIAC': [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')]
        }
    }, cb);
}(jQuery));
